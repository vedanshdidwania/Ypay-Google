    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-light border border-brand/10 text-brand text-xs font-bold uppercase tracking-widest mb-6">
              ...
              <h1 className="text-5xl lg:text-7xl font-display font-bold text-gray-900 tracking-tight leading-[1.1] mb-8">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4">
                <Link to="/p2p" className="btn-primary w-full sm:w-auto px-10 py-4 text-lg">
                  Start Trading
              ...
              <div className="mt-12 flex items-center gap-8 border-t border-gray-100 pt-8">
                <div>
                  ...
                  <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">24h Volume</p>
                </div>
                <div className="w-px h-10 bg-gray-100" />
                <div>
                  <p className="text-2xl font-bold text-gray-900">12k+</p>
                  <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">Active Traders</p>
                </div>
                <div className="w-px h-10 bg-gray-100" />
                <div>
            ...
            >
              <div className="card p-8 shadow-2xl shadow-brand/10 relative z-10">
                <div className="flex items-center justify-between mb-8">
                  <h3 className="text-lg font-bold text-gray-900">Settlement Calculator</h3>
                  <div className="flex items-center gap-1 text-green-600 bg-green-50 px-2 py-1 rounded-lg text-[10px] font-bold uppercase tracking-widest">
                ...
                <div className="space-y-6">
                  <div>
                    <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2 block">You Pay (INR)</label>
                    <div className="relative">
                      ...
                      />
                      <span className="absolute right-4 top-1/2 -translate-y-1/2 font-bold text-gray-400">INR</span>
                    </div>
                  </div>
                  ...
                  <div>
                    <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2 block">You Receive (USDT)</label>
                    <div className="relative">
                      <div className="input-field bg-gray-50 text-2xl font-bold pr-16 text-brand">
                        {usdt}
                      </div>
                  ...
                  <div className="p-4 bg-gray-50 rounded-xl space-y-2">
                    <div className="flex justify-between text-xs">
                      ...
                      <span className="font-medium text-gray-900">1 USDT = ₹{rate}</span>
                    </div>
                    <div className="flex justify-between text-xs">
                      <span className="text-gray-500">Network Fee</span>
                      <span className="font-medium text-green-600">Zero Fee</span>
                    </div>
                  </div>

                  <Link to="/p2p" className="btn-primary w-full py-4">
                    Execute Settlement
                  </Link>
                </div>
              </div>
      ...
      <section className="py-24 border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <h3 className="text-4xl font-display font-bold text-gray-900 mb-6">Simple. Secure. Seamless.</h3>
            <p className="text-gray-600">Three steps to settle your digital assets with absolute confidence.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {[
              ...
              <div key={i} className="relative">
                <div className="text-6xl font-display font-bold text-gray-100 absolute -top-8 -left-4 -z-10">{item.step}</div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <h3 className="text-4xl font-display font-bold text-gray-900 mb-6">Built for the next generation of digital finance.</h3>
            <p className="text-gray-600">Our protocol combines decentralized trust with centralized efficiency to provide the ultimate settlement experience.</p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {features.map((f, i) => (
              <div key={i} className="card p-10 hover:shadow-xl transition-all group">
                <div className={cn("w-14 h-14 rounded-2xl flex items-center justify-center mb-8 transition-transform group-hover:scale-110", f.bg, f.color)}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h3 className="text-4xl font-display font-bold text-gray-900 mb-8">Uncompromising safety for every transaction.</h3>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                ...
                <div className="card p-6">
                  ...
                  <p className="text-2xl font-bold text-gray-900 mb-1">190+</p>
              ...
              <div className="space-y-4 pt-12">
                <div className="card p-6">
                  ...
                  <p className="text-2xl font-bold text-gray-900 mb-1">SOC2</p>
                  <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">Compliant</p>
                </div>
      ...
      <section className="py-24 bg-brand relative overflow-hidden text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center">
          ...
          <p className="text-indigo-100 text-xl mb-12 max-w-2xl mx-auto">Join thousands of traders who have already switched to the most efficient P2P protocol in the market.</p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link to="/dashboard" className="w-full sm:w-auto px-12 py-5 bg-indigo-700 text-white font-bold rounded-2xl hover:bg-indigo-800 transition-all border border-indigo-400/30">
              Contact Sales
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="flex items-center gap-2">
              ...
              <span className="font-display font-bold text-gray-900 tracking-tight text-xl">YPAY</span>
            </div>
            ...
            <p className="text-sm text-gray-400">© 2026 Ypay Protocol. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
