    ...
    <div className="min-h-screen bg-[#050505] pt-24 pb-12">
      <div className="responsive-container page-padding max-w-3xl">
        <div className="text-center mb-12">
          <div className="w-16 h-16 sm:w-20 sm:h-20 bg-brand/10 rounded-full flex items-center justify-center mx-auto mb-6">
            <ShieldCheck className="w-8 h-8 sm:w-10 sm:h-10 text-brand" />
          </div>
          <h1 className="heading-xl mb-3">Identity Verification</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10">
          {[
            ...
            >
              ...
              <p className="label-xs mb-2">{tier.title}</p>
              <p className="text-lg font-bold text-white mb-1">{tier.limit}</p>
              <p className="text-xs text-gray-400">{tier.desc}</p>
              
              {profile?.kyc_level === tier.level - 1 && submission?.status !== 'pending' && (
                <button className="mt-3 w-full py-2 bg-brand/20 hover:bg-brand/30 text-brand text-[10px] font-bold rounded-xl transition-all uppercase tracking-wider">
                  Upgrade Now
                </button>
              )}
            </div>
        ...
        {submission ? (
          <div className="card card-padding text-center">
            {submission.status === 'pending' ? (
              <div className="py-8">
                ...
                <h2 className="heading-lg mb-4">Verification Pending</h2>
              ...
              <div className="py-8">
                ...
                <h2 className="heading-lg mb-4">Verification Approved</h2>
                <p className="text-sm text-gray-400 max-w-sm mx-auto leading-relaxed">
              ...
              <div className="py-8">
                ...
                <h2 className="heading-lg mb-4">Verification Rejected</h2>
                <p className="text-sm text-gray-400 mb-8">
                  Unfortunately, your verification was rejected.
                </p>
                {submission.admin_feedback && (
                  <div className="p-5 bg-red-500/5 border border-red-500/10 rounded-2xl text-red-400 text-sm mb-8 max-w-md mx-auto">
                    <span className="font-bold">Reason:</span> {submission.admin_feedback}
                  </div>
                )}
                <button
          ...
          >
            {error && (
              <div className="mb-8 p-5 bg-red-500/10 border border-red-500/20 rounded-2xl flex items-center gap-4 text-red-400 text-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-12">
              <div className="space-y-6">
                <label className="label-xs ml-1">Document Type</label>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div className="space-y-4">
                  <label className="label-xs ml-1">Front Side</label>
                  <div className="relative">
                    ...
                    <label
                      ...
                      className="w-full aspect-[3/2] border-2 border-dashed border-white/10 rounded-2xl flex flex-col items-center justify-center cursor-pointer hover:border-brand/50 transition-all overflow-hidden bg-white/5"
                    >
                      {frontPreview ? (
                ...
                <div className="space-y-4">
                  <label className="label-xs ml-1">Back Side (Optional)</label>
                  <div className="relative">
                    <input
                      type="file"
                      accept="image/*"
              ...
              <div className="p-6 bg-brand/5 border border-brand/10 rounded-2xl flex flex-col gap-4">
                ...
                {selectedLevel === 3 && (
                  <div className="mt-4 p-5 bg-white/5 border border-white/10 rounded-2xl">
                    <p className="label-xs mb-3">Level 3 Video Script</p>
                    <p className="text-sm text-white italic leading-relaxed">
                      "My name is [Your Name], my document number is [Your ID Number], I want to complete my level 3 verification on Ypay."
                    </p>
                    <p className="text-[10px] text-gray-500 mt-3">Please record a short video of yourself holding your ID and saying the script above.</p>
                  </div>
                )}
              </div>
              ...
              {selectedLevel === 3 && (
                <div className="space-y-6">
                  <label className="label-xs ml-1">Verification Video</label>
                  <div className="relative">
                    <input
                      type="file"
                      accept="video/*"
